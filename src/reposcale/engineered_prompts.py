...
5. Run preflight after editing.
6. Run the validation tool after preflight is clean.
7. Stop when preflight and validation pass, or when you can clearly explain the blocker.
